...
export const siteConfig = {
  ...
  description:
    "Salt på maden. Opskrifter med kant til airfryer, grill, røg, plancha, gryde, pande, sylte, dips, sous vide, trykkoger, dehydrator, røremaskine, pizzaovn og støbejern — enkelt, sprødt og med smag.",
  locale: "da_DK",
  language: "da",
};
