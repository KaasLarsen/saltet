...
export const siteConfig = {
  ...
  description:
    "Salt på maden. Opskrifter med kant til airfryer, grill, plancha, gryde, pande, sylte, dips, sous vide, trykkoger, dehydrator og røremaskine — enkelt, sprødt og med smag.",
  locale: "da_DK",
  language: "da",
};
